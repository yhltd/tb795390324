...
//                List<Lean3> lean3 = lean3Service.getList();
                ...
                Map input_an_as = new HashMap();
                Map input_b_c = new HashMap();
                Map input_b_d = new HashMap();
                Map input_b_e = new HashMap();

                for (int i = 0; i < 20; i++) {
                    input_an_at.put(input7.get(i).getAN(), input7.get(i).getAT());
                    input_an_as.put(input7.get(i).getAN(), input7.get(i).getAS());
                }
                for (int i = 0; i < 33; i++) {
                ...
                for (int i = 0; i < 4; i++) {
                    if(i==0){
                        input_b_c.put(input.get(i).getB(), "E");
                        input_b_d.put(input.get(i).getB(), "D");
                        input_b_e.put(input.get(i).getB(), "B");
                    }else if(i==1){
                        input_b_c.put(input.get(i).getB(), "D");
                        input_b_d.put(input.get(i).getB(), "B");
                        input_b_e.put(input.get(i).getB(), "A");
                    }else if(i==2){
                        input_b_c.put(input.get(i).getB(), "B");
                        input_b_d.put(input.get(i).getB(), "A");
                        input_b_e.put(input.get(i).getB(), "E");
                    }else{
                        input_b_c.put(input.get(i).getB(), "A");
                        input_b_d.put(input.get(i).getB(), "E");
                        input_b_e.put(input.get(i).getB(), "D");
                    }
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (i == 0) {
                        ...
                        list.get(i).setDC(list.get(i).getDB());
                        list.get(i).setDD("0");
                        ...
                        list.get(i).setB(df.format(Double.parseDouble(input2.get(0).getB()) + Double.parseDouble(list.get(i - 1).getB())));
                        if (Double.parseDouble(list.get(i - 1).getO()) > Double.parseDouble(list.get(i - 1).getP())) {
                            list.get(i).setC(input_an_as.get(list.get(i - 1).getC()).toString());
                        } else {
                            list.get(i).setC(list.get(i - 1).getC());
                        }
                        list.get(i).setD(list.get(i).getC().substring(0, 1));
                        list.get(i).setE(input_b_c.get(list.get(i).getD()).toString());
                        list.get(i).setF(input_b_d.get(list.get(i).getD()).toString());
                        list.get(i).setG(input_b_e.get(list.get(i).getD()).toString());
                        double t = Double.parseDouble(list.get(i).getB());
                        if (input2.get(17).equals("male")) {
                            list.get(i).setI((Double.parseDouble(input6.get(4).getG()) * Double.parseDouble(input6.get(3).getG())) + (-0.00000209 * Math.pow(t, 6) + 0.00046936 * Math.pow(t, 5) - 0.04095257 * Math.pow(t, 4) + 1.75290819 * Math.pow(t, 3) - 37.78916029 * Math.pow(t, 2) + 353.56482552 * t + 0.56673857) + "");
                        } else {
                        ...
                        list.get(i).setJ(list.get(i).getC().substring(list.get(i).getC().length() - 1));
                        list.get(i).setK(Double.parseDouble(list.get(i - 1).getK()) * Double.parseDouble(list.get(i - 1).getAX()) * Double.parseDouble(input2.get(0).getB()) + "");
                        list.get(i).setL(Double.parseDouble(list.get(i).getK()) * Double.parseDouble(input2.get(0).getB()) + "");
                        list.get(i).setM(Double.parseDouble(list.get(i - 1).getK()) * Double.parseDouble(input2.get(0).getB()) * (Double.parseDouble(list.get(i - 1).getW()) / Double.parseDouble(list.get(i - 1).getAH())) + Double.parseDouble(list.get(i - 1).getM()) + "");
                        list.get(i).setN((Double.parseDouble(list.get(i).getM()) - Double.parseDouble(list.get(i - 1).getM())) / Double.parseDouble(input2.get(0).getB()) + "");
                        if (!list.get(i).getC().equals(list.get(i - 1).getC())) {
                            list.get(i).setO(Double.parseDouble(list.get(i).getN()) * Double.parseDouble(input2.get(0).getB()) - Double.parseDouble(input2.get(4).getB()) - Double.parseDouble(input2.get(5).getB()) + "");
                        } else {
                            list.get(i).setO(Double.parseDouble(list.get(i).getN()) * Double.parseDouble(input2.get(0).getB()) + Double.parseDouble(list.get(i - 1).getO()) + "");
                        }
                        list.get(i).setP(input_an_at.get(list.get(i).getC()).toString());
                        list.get(i).setH(Double.parseDouble(list.get(i).getN()) * Double.parseDouble(input2.get(0).getB()) + Double.parseDouble(list.get(i - 1).getH()) + "");
                        if (Double.parseDouble(list.get(i).getH()) > Double.parseDouble(list.get(i - 1).getR())) {
                            list.get(i).setQ(Integer.parseInt(list.get(i - 1).getQ()) + 1 + "");
                        } else {
                            list.get(i).setQ(list.get(i - 1).getQ());
                        }
                        list.get(i).setR(input_ah_ai.get(list.get(i).getQ()).toString());
                        if (Double.parseDouble(list.get(i).getR()) > Double.parseDouble(list.get(i - 1).getR())) {
                            list.get(i).setS(list.get(i).getQ());
                        } else {
                            list.get(i).setS("FALSE");
                        }
                        list.get(i).setT("");
                        ...
                        list.get(i).setAW(Double.parseDouble(list.get(i).getAV()) / Double.parseDouble(list.get(i).getK()) + "");
                        list.get(i).setAX(Double.parseDouble(list.get(i).getAW()) / (Double.parseDouble(list.get(i).getAA()) + (Double.parseDouble(input2.get(11).getB()) / Math.pow(Double.parseDouble(input2.get(13).getB()), 2)) + (Double.parseDouble(input2.get(12).getB()) / Math.pow(Double.parseDouble(input2.get(13).getB()), 2))) + "");
                        list.get(i).setAY(Double.parseDouble(list.get(i).getI()) * Double.parseDouble(input2.get(0).getB()) + "");
                        list.get(i).setAZ(list.get(i).getAY());
                        list.get(i).setBA("FALSE");
                        list.get(i).setBB(Double.parseDouble(list.get(i).getI()) / Double.parseDouble(list.get(i).getAB()) + "");
                        list.get(i).setBC(Double.parseDouble(list.get(i).getAX()) * Double.parseDouble(list.get(i).getAA()) * Double.parseDouble(list.get(i).getK()) + "");
                        ...
                        list.get(i).setBT(list.get(i).getI());
                        list.get(i).setBU(Double.parseDouble(list.get(i).getBT()) * Double.parseDouble(input2.get(0).getB()) + "");
                        list.get(i).setBV(list.get(i).getBU() + list.get(i - 1).getBV());
                        list.get(i).setBW("0");
                        list.get(i).setBX(list.get(i).getBW());
                        if (i + 1 < 5.0 / Double.parseDouble(input2.get(0).getB())) {
                            list.get(i).setBY("FALSE");
